...
(
    country_id int     not null default nextval('countries_id_seq'),
    code       varchar(2)   not null unique,
    name       varchar(255) not null,
    primary key (country_id)
);

create sequence states_id_seq start with 1 increment by 1;

create table states
(
    state_id   int     not null default nextval('states_id_seq'),
